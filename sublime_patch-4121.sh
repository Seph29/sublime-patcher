...
patch() {
	...
	echo "Patching '$1'..."
	sudo sed -i 's/\x55\x41\x57\x41/\x48\x31\xC0\xC3/g' $1
	sudo sed -i 's/\xE8\x0C\xBC\x11\x00/\x90\x90\x90\x90\x90/g' $1
	sudo sed -i 's/\xE8\xF6\xBB\x11\x00/\x90\x90\x90\x90\x90/g' $1
	sudo sed -i 's/\x55\x41\x56\x53\x41\x89\xF6/\x48\x31\xC0\x48\xFF\xC0\xC3/g' $1
